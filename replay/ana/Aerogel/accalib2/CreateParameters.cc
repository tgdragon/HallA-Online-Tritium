/*
  ...
  obtained by the fitting (A2)

  Toshiyuki Gogami, Oct 6, 2018
*/

const int n = 26; // The number of channels in A2


void CreateParameters(){
  ifstream* org_param = new ifstream("org.dat");
  ifstream* new_param = new ifstream("a2_fitresults.dat");
  ...
  *org_param >> tempc;
  ...
  ofstream* ofs = new ofstream("db_R.a2.dat_newpedgain");
  *ofs << "R.a2.adc.pedestals = ";
  for(int i=0 ; i<n ; i++){
