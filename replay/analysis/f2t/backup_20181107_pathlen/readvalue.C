...
////////////////////////////////////////////////////////////
{
 ...
 //tree->SetBranchAddress("EXFP3",&XFP);
 //tree->SetBranchAddress("EXpFP3",&XpFP);
 //tree->SetBranchAddress("EYFP3",&YFP);
 //tree->SetBranchAddress("EYpFP3",&YpFP);
 ...
 //tree->SetBranchAddress("EDCTrig",&SPLTrig);
