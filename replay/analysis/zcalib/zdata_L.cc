...
void zdata_L(){
  ...
  TFile* fnew = new TFile("zt_lhrs.root","recreate");
  TTree* tnew = new TTree("tree","For z calibration (LHRS)");
  double ztR[max], ztR_R[max];
  ...
  tnew->Branch("R.tr.vz_TG",  &ztR_R, "R.tr.vz_TG[100]/D" );
  ...
  char name_Mzt[500];
  //sprintf(name_Mzt,"matrices/zt_LHRS_2.dat"); // original
  //sprintf(name_Mzt,"tune1/newpar_4.dat"); // 
  //sprintf(name_Mzt,"tune3/newpar_4.dat"); // 
  //sprintf(name_Mzt,"tune4/newpar_9.dat"); // 
  //sprintf(name_Mzt,"tune5/newpar_9.dat"); // 
  //sprintf(name_Mzt,"tune6/newpar_9.dat"); // 
  //sprintf(name_Mzt,"tune7/newpar_9.dat"); // 
  //sprintf(name_Mzt,"tune8/newpar_9.dat"); // 
  //sprintf(name_Mzt,"tune9/newpar_9.dat"); // 
  sprintf(name_Mzt,"matrices/zt_LHRS_opt.dat"); // optimized
  ...
  for (int i=0 ; i< ent ; i++){
    ...
    if(//rtrig==true
      ...
      //ztR[0]  = calcf2t_zt(Pzt_R, -XFP, -XpFP, YFP, YpFP); // (using R for L)
      ztR_R[0] = calcf2t_zt(Pzt_R, XFP, XpFP, YFP, YpFP);
      
      ztR[0]   = ztR[0]   * Ztr + Ztm;
      ztR_R[0] = ztR_R[0] * Ztr + Ztm;
      XFP = XFP * XFPr + XFPm;
