...
void hist_h22(){
  ...
  // ===== Open ROOT file ======== //
  // ============================== //
  TFile* f1 = new TFile("h22_20190912.root");
  ...
  //TH1F* hist1  = new TH1F("hist1","",250,-100.0,140.0);
  ...
  //c1->Print("mm_H22_20190912.png");
  //c2->Print("ctime_H22_20190912.png");
  //c3->Print("momcor_H22_20190912.png");
