...
void adc_tof(){
  ...
  // ====== Open ROOT file ============
  TFile* f1 = new TFile("phc_ehodo_20171119.root");
  TTree* t1 = (TTree*)f1->Get("tree");
  
  // ====== Cut conditions ============
  TCut cut1 = "adc1>500 && adc1<2000.0 && abs(time1-31.6)<5.0";
  TCut cut2 = "adc2>500 && adc2<2000.0 && abs(time2-21.3)<5.0";
  TCut cut3 = "adc3>500 && adc3<2000.0 && abs(time3-24.6)<5.0";
  TCut cut4 = "adc4>500 && adc4<2000.0 && abs(time4-22.8)<5.0";
  ...
  hist1->GetXaxis()->SetRangeUser(500.0,1500.);
  hist1->GetYaxis()->SetRangeUser(-4.0,4.0);
  ...
  func1->SetParameters(40.0,0.0,0.13);
