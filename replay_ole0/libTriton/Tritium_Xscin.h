#ifndef ROOT_Tritium_Xscin
#define ROOT_Tritium_Xscin
...
public:
  Tritium_Xscin( const char* name, 
	     const char* description = "",
	     Bool_t flip = kFALSE,
	     THaApparatus* a = NULL );
  virtual ~Tritium_Xscin();
...
protected:
  ...
  ClassDef(Tritium_Xscin,0)   // Generic scintillator class
};
