#ifndef ROOT_TriScintillator
#define ROOT_TriScintillator
...
class TriScintillator : public TriNonTrackingDetector {

public:
  TriScintillator( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~TriScintillator();
...
protected:
  ...
  ClassDef(TriScintillator,0)   // Generic scintillator class
};
