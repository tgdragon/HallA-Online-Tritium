///////////////////////////////////////////////////////////////////////////////
//                                                                           //
// TriFadcScinF1 (11202017 Hanjie Liu hanjie@jlab.org)                         //
...
TriFadcScinF1::TriFadcScinF1( const char* name, const char* description,
...
//_____________________________________________________________________________
THaAnalysisObject::EStatus TriFadcScinF1::Init( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
void TriFadcScinF1::DeleteArrays()
{
  ...
  delete [] fLPeak;  fLPeak = NULL;
  delete [] fRPeak;  fRPeak = NULL;
...
//_____________________________________________________________________________
void TriFadcScinF1::Clear( Option_t* opt )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::Decode( const THaEvData& evdata )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::ApplyCorrections()
{
...
//_____________________________________________________________________________
Double_t TriFadcScinF1::TimeWalkCorrection( const Int_t& paddle,
					      const ESide side )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::CoarseProcess( TClonesArray& tracks )
{
...
//_____________________________________________________________________________
Int_t TriFadcScinF1::FineProcess( TClonesArray& tracks )
{
